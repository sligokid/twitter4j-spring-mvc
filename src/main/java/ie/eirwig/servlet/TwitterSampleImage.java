...
@WebServlet("/TwitterSampleImage")
public class TwitterSampleImage extends BaseHttpServlet {
	...
	public TwitterSampleImage() throws FileNotFoundException, IOException {
